...
public class TestBase {
	...
	public TestBase() {
		...
		try {
			...
			FileInputStream ip = new FileInputStream(
					"D:\\Learning\\Selenium Workbook\\FreeCRMTest\\src\\main\\java\\com\\crm\\qa\\config\\config.properties");
			prop.load(ip);
	...
	public static void initialization() {
		...
		//driver.manage().timeouts().pageLoadTimeout(TestUtil.PAGE_LOAD_TIMEOUT, TimeUnit.SECONDS); // referring the time
																									// from the TestUtil
																									// class in util
																									// package
